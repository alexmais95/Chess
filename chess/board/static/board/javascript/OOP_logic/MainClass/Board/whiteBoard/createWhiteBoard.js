...
import GenerateIdForWhiteBoard from "./generateIdForWhiteBoard.js";


class CreateWhiteBoard extends AbsCreateBoard {
    constructor() {
        super()
        this.gameBoard = document.querySelector('.board-container');
        this.id_generetor = new GenerateIdForWhiteBoard()
    }
